...
export default async function seed() {
	...
	await db.insert(Products).values(
		...
		description: "Esta es la descripcion de un producto totalmente random, es un super hiper duper producto de material de ultima generacion, es la mas mejor, muchas gracias por leer tooooooooodoooooo este texto" },
